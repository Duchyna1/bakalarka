...
public class RAJoin extends RAExpr {
    private final List<RAExpr> relations;
    private final List<List<Term>> inputTerms;
    private final List<Term> outputTerms;
    
    public RAJoin(List<RAExpr> relations, List<List<Term>> inputTerms, List<Term> outputTerms) {
    ...
    public String toString() {
        ...
        return "JOIN([" + relationsString + "], [" + inputTermsString + "], [" + outputTermsString + "])";
    }
}
