...
Cieľom tejto bakalárskej práce bolo rozšíriť náš experimentálny databázový systém o deklaratívny
dotazovací jazyk Datalog s funkčnými symbolmi a vstavanými predikátmi, a implementovať kompilátor,
...
samotný viacstupňový algoritmus prekladu do relačnej algebry. Výsledkom je kompilátor, ktorý vykonáva
...
Kompilátor umožňuje používateľovi formulovať dotazy v rozšírenom Datalogu, ktorý je prirodzenejší a
stručnejší, pričom výsledný výraz relačnej algebry je generovaný automaticky. Týmto sme dosiahli
stanovený cieľ a zároveň sme vytvorili nástroj, ktorý môže byť ďalej rozšírený a integrovaný do
rôznych databázových systémov.
