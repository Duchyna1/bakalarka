...
\begin{todo}
    Doplniť niečo o tom, prečo chceme funkčné symboli.
\end{todo}

\begin{definition}
    Za \textbf{term} považujeme:
    \begin{itemize}
        \item ľubovoľný 0-árny funkčný symbol (ktorý považujeme za \textit{konštantu}, môžeme zapisovať aj bez zátvoriek),
...
Rozširime definíciu jazyka logiky (\ref{znaky_jazyka_1}) o symboly označujúce funkčné symboly. Do predikátov
% TODO link na def
potom nedosadzujeme premenné a konštanty, ale termy.
