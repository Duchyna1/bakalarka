...
\begin{note}
    ...
    n-tica, aby spĺňala vstupný vektor. Týmto sa môžu konkretizovať niektoré premenné. Potom sa
    zoberie druhá relácia a jej vstupný vektor (s už konkretizovanými premennými) a spraví sa to
...
\end{verbatim}
    ...
    ovplyvniť výsledok. Náš kompilátor zoberie najprv kladné atómy v poradí a následne negované atómy
