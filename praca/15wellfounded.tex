...
$p(2)$ a $p(3)$, je tiež modelom. Minimálny model je však ten prvý, pretože žiadna interpretácia,
ktorej pravdivé atómy tvoria striktnú podmnožinu minimálneho modelu, nie je modelom.
