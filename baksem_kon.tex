...
\begin{enumerate}
    ...
    \begin{enumerate} 
        \item Definície \quad Väčšina
        \item Rozšírenie datalogu o funkčné symboly \quad Väčšina
        \item Syntax rozšíreného datalogu \quad Väčšina
        \item Well-founded model \quad Napísať
    \end{enumerate}
    \item Relačná algebra \qquad 1.4. 
    \begin{enumerate}
        \item Definície \quad Väčšina
        \item Inklúzia medzi učebnicovou a našou relačnou algebrou \quad Napísať
    \end{enumerate}
